...
echo.
if /I "%lower_quality%" EQU "Y" scrcpy -s %ip%:5555 --no-audio --video-bit-rate 2M --max-size 800 --crop 1730:974:1934:450 --max-fps 30
if /I "%lower_quality%" EQU "N" scrcpy -s %ip%:5555 --no-audio --crop 1730:974:1934:450 --max-fps 30